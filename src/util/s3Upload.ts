 ...
 */
export async function uploadToS3(dataUrl: string, fileName: string, bucket: string, region: string, identityPoolId: string): Promise<string> {
    ...
    try {
        ...
        // Optional: you can define a folder structure, e.g., 'signatures/'
        ...
        // Construct the expected object URL
